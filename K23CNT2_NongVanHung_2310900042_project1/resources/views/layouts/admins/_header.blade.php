...
<header class="bg-bule text-white p-3">
    <div class="container d-flex justify-content-between align-items-center">
        <!-- Logo -->
        <div class="logo">
            <a href="/nvh-admins" class="text-white text-decoration-none">
                <img 
        ...
        <!-- Menu Navigation -->
        <!-- Search form -->
        <form action="{{ route('nvhuser.searchAdmins') }}" method="GET" class="search-form">
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="{{route('admins.nvhlogin')}}" class="text-white text-decoration-none" style="font-size: 14px;">Đăng xuất</a>
        </div>
    </div>
</header>
