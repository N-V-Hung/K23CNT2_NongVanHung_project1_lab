    ...
    <nav class="bg-gradient-to-r from-blue-500 to-purple-500 p-4">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link hover:text-gray-300" href="{{route('nvhuser.lienhe')}}">Liên Hệ</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link hover:text-gray-300" href="{{route('nvhuser.gioithieu')}}">Giới Thiệu</a>
                </li>
