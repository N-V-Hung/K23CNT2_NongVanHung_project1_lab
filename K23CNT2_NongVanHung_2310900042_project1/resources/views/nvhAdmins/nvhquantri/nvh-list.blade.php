                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="btn-group" role="group">
                                    <!-- Xem chi tiết -->
                                    <a href="/nvh-admins/nvh-quan-tri/nvh-detail/{{ $item->id }}" class="btn btn-success btn-sm" title="Xem">Xem
                                        <i class="fa-solid fa-eye"></i>
                                    </a>
                                    <!-- Chỉnh sửa -->
                                    <a href="/nvh-admins/nvh-quan-tri/nvh-edit/{{ $item->id }}" class="btn btn-primary btn-sm" title="Chỉnh sửa">Sửa
